...
import com.mhyne.template.NavigationActivity
import com.mhyne.template.core.data.source.remote.network.State
import com.mhyne.template.core.data.source.remote.request.RegisterRequest
import com.mhyne.template.databinding.ActivityRegisterBinding
...
//                    showToast("Selamat Datang " + it?.body?.name)
                    ...
                    pushActivity(com.mhyne.template.NavigationActivity::class.java)
                }
                State.ERROR ->{
                    dismisLoading()
